if (document.getElementById('home-index')) {
	...
	//        } else if ( $('#available-fixtures').hasClass('residential-fixtures') ) {
    ...
    $('dt').on('click', function(evt) {
        $(this).parents('.faqs.container').find('dt').addClass('collapsed');
